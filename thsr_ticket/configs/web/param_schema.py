...
BookingRequestParams = TypedDict(
    "BookingRequestParams",
    {
        "BookingS1Form:hf:0": str,
        "selectStartStation": int,
        "selectDestinationStation": int,
        "trainCon:trainRadioGroup": int,
        "tripCon:typesoftrip": int,
        "seatCon:seatRadioGroup": int,
        "bookingMethod": str,
        "toTimeInputField": str,
        "toTimeTable": str,
        "toTrainIDInputField": Optional[str],
        "backTimeInputField": Optional[str],
        "backTimeTable": Optional[str],
        "backTrainIDInputField": Optional[str],
        "ticketPanel:rows:0:ticketAmount": str,
        "ticketPanel:rows:1:ticketAmount": str,
        "ticketPanel:rows:2:ticketAmount": str,
        "ticketPanel:rows:3:ticketAmount": str,
        "ticketPanel:rows:4:ticketAmount": str,
        "trainTypeContainer:typesoftrain": int,
        "homeCaptcha:securityCode": str,
    },
    total=False,
)

ConfirmTrainRequestParams = TypedDict(
...
ConfirmTicketRequestParams = TypedDict(
    "ConfirmTicketRequestParams",
    {
        ...
        "TgoError": int,
        "passengerCount": int,
        "isEarlyBirdRegister": int,
        "isSPromotion": int,
        "isMustBeCard": int,
        "TicketMemberSystemInputPanel:TakerMemberSystemDataView:memberSystemRadioGroup": str,
        "TicketPassengerInfoInputPanel:passengerDataView:0:passengerDataView2:passengerDataInputChoice": int,
        "TicketPassengerInfoInputPanel:passengerDataView:0:passengerDataView2:passengerDataIdNumber": str,
        "idNumber": str,
    },
    total=False,
)
...
class Train(BaseModel):
    ...
    travel_time: str
    discount_str: str
    discount_tags: list[str] = Field(default_factory=list)
